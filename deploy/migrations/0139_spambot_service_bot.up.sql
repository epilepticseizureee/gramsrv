INSERT INTO public.users (
    ...
    178220800, 5487628193046157217, '', 'Spam Info Bot', '', 'SpamBot', '',
    now(), now(), true, false,
    'The official Spam Info Bot. Helps users with limited accounts regain the full functionality.',
...
VALUES ('spambot', 'user', 178220800, now())
...
VALUES
    ('contact_account', 178220800, 'user', 178220800, 1, now(), 1782208000001),
    ('channel_active_memberships', 178220800, 'user', 178220800, 1, now(), 1782208000002)
